...
pub fn get_lite_data_bytes_string(price_data: SerializedPriceData) -> String {
    ...
    for (symbol, value) in price_data.map_symbol_value.iter() {
        ...
        // let num = 0.7634302478595417_f64;
        let num = value;
        let scaled_num = (((num * 100000000_f64).round() / 100000000_f64) * 100000000_f64) as u64;
        println!("scaled_num {}", scaled_num);
        println!("scaled_num {}", num * 100000000_f64);
        println!("scaled_num {}", (num * 100000000_f64).round());
        println!("scaled_num {}", ((num * 100000000_f64).round() / 100000000_f64));
